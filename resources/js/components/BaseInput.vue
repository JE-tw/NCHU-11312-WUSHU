<template>
  <div class="relative w-full min-w-[0]">
    <input
      ...
      :class="[
        inputClass,
        'peer mt-4 block w-full appearance-none rounded-md border border-gray-300 px-3 pb-2 pt-4 text-sm focus:border-blue-600 focus:outline-none focus:ring-0',
        disabled ? ' bg-slate-300 text-gray-500 cursor-not-allowed' : 'bg-white text-gray-900'
      ]"
      :disabled="disabled"
      :readonly="readonly"
